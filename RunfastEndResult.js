...
cc.Class({
    ...
    start() {
        ...
        if(this.theEndBtn) this.theEndBtn.node.on(cc.Node.EventType.TOUCH_END, this.oneTheEndBtnClick.bind(this));
        if(this.retArrowBtn) this.retArrowBtn.node.on(cc.Node.EventType.TOUCH_END, this.oneTheEndBtnClick.bind(this));
    },
    ...
    setResult(resultInfo, runfastLogic) {
